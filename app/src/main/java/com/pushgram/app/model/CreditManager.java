...
public class CreditManager {
    ...
    public static synchronized CreditManager getInstance(Context context) {
        if (instance == null) instance = new CreditManager(context);
        return instance;
    }

    public int getCredits() { return prefs.getInt(KEY_CREDITS, 0); }

    public void addCredit() {
        prefs.edit()
                .putInt(KEY_CREDITS, getCredits() + 1)
    ...
    public int getTotalPushups() { return prefs.getInt(KEY_TOTAL_PUSHUPS, 0); }
    public boolean hasCredits() { return getCredits() > 0; }
}
